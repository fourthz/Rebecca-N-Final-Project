...
RWS_RQ1 <- RWS_Data %>%
  ...
  ggplot(aes(x = WA_GPA, y = Optimism_Score) +
  geom_point() +
  stat_smooth(method = "lm", se = FALSE) +
  labs(x = "Senior Weighted Average GPA",
       y = "Optimism Score",
       title = "Relationship of Weighted Average GPA and Optimism Score")
RWS_RQ1

```

#### Team Leader Mike - I can't seem to get correlation to wrork.
